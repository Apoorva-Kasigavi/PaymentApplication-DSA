...
// Variable to take choice input from the user
// Can be used for:
//  -- switch cases
//  -- menu options
...
// It carries the indexes of the results in the account table
...
//String variable to store the pattern to be searched
char text[25];
